...
public:
    ...
    void drawText(const QStyleOptionViewItem *option, QPainter *painter, QRect rectTextOriginal);
...
private:
    ...
    const qreal MARK_PADDING_TOP = 7;    // 选中标记上侧内边距
    const qreal MARK_PADDING_BOTTOM = 7; // 选中标记下侧内边距
